   ...
   const stages = [
        {
            ...
            desc: "We engineer robust, cloud-native architectures designed to evolve seamlessly alongside your business growth.",
            // Visual: Abstract server/blue-print feel (Architecture)
            img: "/about-1.jpeg",
        },
        {
            title: "Fortified Security",
            desc: "Beyond standard protection—we implement a zero-trust framework to safeguard your digital assets 24/7.",
            // Visual: Minimalist/Dark tech feel (Modern Security)
            img: "/about-2.jpeg",
        },
        {
            title: "Continuous Optimization",
            desc: "We move beyond maintenance to proactive evolution, ensuring 99.9% uptime and peak system performance.",
            // Visual: Clean dashboard/analytics (Efficiency)
            img: "about-3.jpeg",
        },
    ];
    useGSAP(() => {
