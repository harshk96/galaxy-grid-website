    ...
    return (
        <>
            ...
            <nav className={`fixed top-6 right-6 z-50 flex items-center gap-4 px-6 py-3 rounded-full border backdrop-blur-md transition-all duration-300 ${isDark
                ...
                <button
                    onClick={toggleTheme}
                    className="text-xs font-mono uppercase hover:text-[#ec2626] transition-colors"
                >
                    {isDark ? 'Light' : 'Dark'}
                </button>
                ...
                <button
                    onClick={onOpenNav}
                    className="flex items-center gap-2 text-sm font-bold uppercase hover:text-[#ec2626] transition-colors"
                >
                    Menu <FaBars />
                </button>
            </nav>
