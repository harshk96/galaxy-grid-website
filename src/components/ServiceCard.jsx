    ...
    return (
        ...
        >
            ...
            <div className="h-full w-full relative overflow-hidden">
                ...
                {/* Animated border */}
                <div className={`absolute inset-0 border-2 border-purple-500/0 transition-all duration-500 ${isHovered ? 'border-opacity-100 rounded-3xl' : 'border-opacity-0 rounded-3xl'}`}></div>
            </div>
            ...
            {/* Hover overlay */}
            <div className={`absolute inset-0 bg-gradient-to-t from-purple-900/40 to-transparent transition-opacity duration-500 ${isHovered ? 'opacity-100' : 'opacity-0'}`}></div>
        </div>
    );
};
