...
const Features = ({ isDark }) => {
    const features = [
        { title: "Zero Downtime", desc: "Designed so your work never stops, ever." },
        { title: "Expert Support", desc: "Single partner for Network, Server, Cloud, and AI." },
        { title: "Full Transparency", desc: "Complete documentation of every configuration." }
    ];
